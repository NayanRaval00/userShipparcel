                                ...
                                <div id="div_add_products" class="">
                                    <div class="row div_add_products">
                                        ...
                                        <div class="col-md-1 col-lg-1 col-xl-1 mb-3">
                                            ...
                                            <button type="button" class="btn btn-success m-0" data-toggle="tooltip" id="btn_add_products" name="btn_add_products" data-original-title="Add Product"><i class="fa fa-plus"></i><svg xmlns="http://www.w3.org/2000/svg" width="0.88em" height="1em" viewBox="0 0 448 512"><path fill="currentColor" d="M64 80c-8.8 0-16 7.2-16 16v320c0 8.8 7.2 16 16 16h320c8.8 0 16-7.2 16-16V96c0-8.8-7.2-16-16-16zM0 96c0-35.3 28.7-64 64-64h320c35.3 0 64 28.7 64 64v320c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64zm200 248v-64h-64c-13.3 0-24-10.7-24-24s10.7-24 24-24h64v-64c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24h-64v64c0 13.3-10.7 24-24 24s-24-10.7-24-24"></path></svg></button>
                                        </div>
                                    </div>
                                </div>
                                <h6>Order Details:</h6>
